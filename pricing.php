...
<html lang="en">
  ...
  <div class="dark-wrapper">
    <div class="container inner">
	  ...
	  <p class="text-center">Due to the nature of the business, we kindly ask you to pay via Paypal gift to avoid extra fees which will then increase our service fees as well. </br>During the payment process on Paypal, attach a note with your account username and email. Please allow a 6-12 hour delay to update your account status. </br> Feel free to contact us at <a href="mailto:dk13rope@gmail.com">dk13rope@gmail.com</a> if you experience any issues.</p>
      <div class="row">
        <div class="col-sm-4">
          <div class="pricing panel">
            ...
            <div class="panel-body">
              <table class="table">
                ...
                <tr>
                  <td><strong>Updates:</strong> weekly updates to our new content</td>
                </tr>
              </table>
            </div>
            <!--/.panel-body -->
        ...
        <div class="col-sm-4">
          <div class="pricing panel">
            <div class="panel-heading">
              ...
              <div class="price"> <span class="price-currency">$</span> <span class="price-value">25</span> </div>
            </div>
            <!--/.panel-heading -->
            <div class="panel-body">
              <table class="table">
